...
globalkeys = awful.util.table.join(
	...
	-- Apps
	awful.key({ modkey,           }, "d", function() awful.util.spawn_with_shell("/opt/synapse/bin/synapse") end),
	-- screen lock
	...
	awful.key({                   }, "XF86AudioMicMute",
		function() 
			awful.util.spawn_with_shell("pactl set-sink-mute 0 -- toggle; notify-send 'Volume' `~/.i3/volume-info.sh`") 
		end),
	-- terminal
...
--
--
dofile(awful.util.getdir("config") .. "/rc.d/" .. "startup.lua")
